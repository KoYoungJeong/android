...
//    private Subscription messageHandlingQueue;
...
//
//        messageHandlingQueue = messagePublishSubject
...
//                insertTeamMemberEmptyLayout();
//            } else if (topicMemberCount <= 1) {
//                insertTopicMemberEmptyLayout();
//            } else {
//                clearEmptyMessageLayout();
//            }
//
//        } else {
...
//
//        if (roomId > 0) {
//            messageListModel.saveTempWritingMessage(roomId, messageListPresenter.getSendEditText());
//        }
