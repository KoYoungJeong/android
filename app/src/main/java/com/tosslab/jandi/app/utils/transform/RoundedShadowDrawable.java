...
//            drawShadow(canvas);
    ...
    RoundedShadowDrawable(Resources res, Bitmap bitmap) {
        if (res != null) {
    ...
    public static RoundedShadowDrawable create(Resources resources, Bitmap bitmap) {
        if (Build.VERSION.SDK_INT >= 21) {
            return new RoundedShadowDrawable21(resources, bitmap);
        }
        return new DefaultRoundedShadowDrawable(resources, bitmap);
    }

    private static class DefaultRoundedShadowDrawable extends RoundedShadowDrawable {

        DefaultRoundedShadowDrawable(Resources res, Bitmap bitmap) {
            super(res, bitmap);
        }
    ...
    private static class RoundedShadowDrawable21 extends RoundedShadowDrawable {

        RoundedShadowDrawable21(Resources res, Bitmap bitmap) {
            super(res, bitmap);
        }
