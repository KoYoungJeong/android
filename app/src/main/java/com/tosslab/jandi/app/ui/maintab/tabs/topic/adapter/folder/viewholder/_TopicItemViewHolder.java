...
public class _TopicItemViewHolder extends MainTopicViewHolder<_TopicItemData> {
    ...
    public _TopicItemViewHolder(View itemView) {
        super(itemView);
    ...
    @Override
    public void bind(_TopicItemData item) {
        if (item == null) {
            return;
        }
