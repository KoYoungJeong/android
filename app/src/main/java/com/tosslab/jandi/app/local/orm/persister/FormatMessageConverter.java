...
public class FormatMessageConverter extends BaseDataType {
    ...
    public Object javaToSqlArg(FieldType fieldType, Object javaObject) throws SQLException {
        if (javaObject instanceof FormatParam) {
            try {
                return JacksonMapper.getInstance().getObjectMapper().writeValueAsString(javaObject);
    ...
    public Object sqlArgToJava(FieldType fieldType, Object sqlArg, int columnPos) throws SQLException {
        if (sqlArg instanceof String) {
            try {
                FormatParam formatParam = JacksonMapper.getInstance().getObjectMapper().readValue(((String) sqlArg), FormatParam.class);
