...
public abstract class ProgressTarget<T, Z> extends WrappingTarget<Z> implements JandiGlideModule.UIProgressListener {
    private T model;
    ...
    private void start() {
        JandiGlideModule.expect(toUrlString(model), this);
    ...
    private void cleanup() {
        ...
        onDelivered();
        JandiGlideModule.forget(toUrlString(model));
        this.model = null;
    }
