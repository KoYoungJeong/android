...
public class JandiPreference {
    ...
    public static final String PREF_LATEST_PUSHTOKEN_UPDATE = "latest_pushtoken_update";
    ...
    public static void setLatestPushTokenUpdate(long time) {
        getSharedPreferences().edit()
                .putLong(PREF_LATEST_PUSHTOKEN_UPDATE, time)
                .commit();
    }

    public static long getLatestPushTokenUpdate() {
        return getSharedPreferences().getLong(PREF_LATEST_PUSHTOKEN_UPDATE, 0);
    }
