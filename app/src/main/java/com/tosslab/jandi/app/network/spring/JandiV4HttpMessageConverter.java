...
/**
 * Created by tonyjs on 2015. 6. 1..
 * MappingJacksonHttpMessageConverter 을 참조하였음.
 */
public class JandiV4HttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    public static final String APPLICATION_VERSION_NAME = "vnd.tosslab.jandi-v4+json";
    public static final String APPLICATION_VERSION_FULL_NAME =
            "application/vnd.tosslab.jandi-v4+json";
     ...
     */
    public JandiV4HttpMessageConverter() {
        super(
