...
public class PreviousJandiPushIntentService extends IntentService {
    ...
    public PreviousJandiPushIntentService() {
        super(TAG);
    }
    ...
    public void onCreate() {
        super.onCreate();
        jandiPushReceiverModel = PreviousJandiPushReceiverModel_.getInstance_(getApplicationContext());
        pushHandler = PreviousPushHandler.getInstance();
    }
