 ...
 */
public class PollInfoTextVisitor implements TextVisitor {

    private Context context;
    private int textColor;

    public PollInfoTextVisitor(Context context, int textColor) {
    ...
    public void visit(SpannableStringBuilder builder, ResMessageSearch.Record record) {
        if (!(TextUtils.equals(record.getType(), "poll"))) {
            return;
        }
        ...
        String name = TeamInfoLoader.getInstance().getMemberName(record.getPollInfo().getCreatorId());
