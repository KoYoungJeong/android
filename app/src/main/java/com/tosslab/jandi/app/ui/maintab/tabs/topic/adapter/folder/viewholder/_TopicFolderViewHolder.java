...
public class _TopicFolderViewHolder extends MainTopicViewHolder<_TopicFolderData> {
    ...
    public _TopicFolderViewHolder(View itemView) {
        super(itemView);
    ...
    @Override
    public void bind(_TopicFolderData item) {
        if (item == null) {
            return;
        }
