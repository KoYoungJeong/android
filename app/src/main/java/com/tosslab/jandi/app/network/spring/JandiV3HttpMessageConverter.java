 ...
 */
public class JandiV3HttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    public static final String APPLICATION_VERSION_NAME = "vnd.tosslab.jandi-v3+json";
    public static final String APPLICATION_VERSION_FULL_NAME = "application/vnd.tosslab.jandi-v3+json";
     ...
     */
    public JandiV3HttpMessageConverter() {
        super(
    ...
    /**
     * Return the Jackson {@link org.codehaus.jackson.type.JavaType} for the specified class.
