...
public class AnalyticsValue {
    public enum Screen {
        ...
        ForceTeamCreation,
        FolderManagement, InviteTeamMembers_Department, InviteTeamMembers_JobTitle, InviteMemberSearch, SelectTeamMember, SelectTeamMemberSearch, TeamInformation, TeamTab_Department, TeamTab_JobTitle, TeamTabSearch, ImageFullScreen, EditAccount
    }
