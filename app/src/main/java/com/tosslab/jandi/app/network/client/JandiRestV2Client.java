 ...
 */
public interface JandiRestV2Client {
    ...
    @Headers("Accept :"+ JandiConstants.HTTP_ACCEPT_HEADER_DEFAULT)
    ResMyTeam getTeamId(@Path("userEmail") String userEmail);
    ...
    @POST("/accounts")
    @Headers("Accept :"+ JandiConstants.HTTP_ACCEPT_HEADER_DEFAULT)
    ResAccountInfo signUpAccount(@Body ReqSignUpInfo signUpInfo);
    ...
    @Headers("Accept :"+ JandiConstants.HTTP_ACCEPT_HEADER_DEFAULT)
    ResAccountInfo activateAccount(@Body ReqAccountActivate reqAccountActivate);
